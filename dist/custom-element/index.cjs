...
var SnapSlider = class {
  ...
  pagerToSlide(event) {
    ...
    targetSlide == null ? void 0 : targetSlide.scrollIntoView({ block: "nearest", inline: "start" });
  }
  eventHandler(event) {
...
// src/custom-element/module.js
var SnapSliderElement = class extends HTMLElement {
  constructor() {
    super();
    this.slider = null;
  }
