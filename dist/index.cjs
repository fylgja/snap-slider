  ...
  "src/snap-slider.js"() {
    var SnapSlider = class extends HTMLElement {
      ...
      setupNavigationButtons() {
        var _a, _b;
        (_a = this.prevBtn) == null ? void 0 : _a.removeAttribute("hidden");
        (_b = this.nextBtn) == null ? void 0 : _b.removeAttribute("hidden");
      ...
      updatePager() {
        ...
        inViewItems.forEach((visibleSlide) => {
          ...
          pagerLinks.forEach((link) => {
            var _a;
            const linkId = ((_a = link.getAttribute("href")) == null ? void 0 : _a.slice(1)) || link.getAttribute("data-slide-id");
            if (linkId === slideId) {
      ...
      setupPagerLinks() {
        ...
        pagerLinks.forEach((link, index) => {
          ...
          const slideId = ((_a = link.getAttribute("href")) == null ? void 0 : _a.slice(1)) || link.getAttribute("data-slide-id");
        ...
        this.pager.addEventListener("click", (e) => {
          ...
          e.preventDefault();
          const slideId = ((_a = clickedButtonOrLink.getAttribute("href")) == null ? void 0 : _a.slice(1)) || clickedButtonOrLink.getAttribute("data-slide-id");
